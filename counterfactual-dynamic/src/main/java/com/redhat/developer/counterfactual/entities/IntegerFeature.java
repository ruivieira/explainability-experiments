...
@PlanningEntity
public class IntegerFeature implements CounterfactualEntity {
    ...
    public IntegerFeature(Feature feature, int minimum, int maximum, boolean constrained) {
    ...
    public IntegerFeature(Feature feature, int minimum, int maximum) {
