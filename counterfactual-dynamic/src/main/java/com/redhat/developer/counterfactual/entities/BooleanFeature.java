...
@PlanningEntity
public class BooleanFeature implements CounterfactualEntity {
    ...
    public BooleanFeature(Feature feature, boolean constrained) {
        this.value = (Boolean) feature.getValue().getUnderlyingObject();
        this.feature = feature;
        this.constrained = constrained;
    }

    public BooleanFeature(Feature feature) {
        this(feature, false);
    }
